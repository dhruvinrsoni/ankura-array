...
(function () {
  ...
  function importFromBmsPaste(text) {
    ...
    var validVersions = ['mancha-matrix-v1', 'mancha-matrix-v2', 'mancha-matrix-v3', 'mancha-matrix-v4', 'mancha-matrix-v5', 'mancha-matrix-v6'];
